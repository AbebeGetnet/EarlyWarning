...
{
    [Authorize]
    public class PastureStatusController : Controller
    {
        private readonly PastureStatusService _service;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly EarlyWarningDbContext _dbContext;

        public PastureStatusController(PastureStatusService service, UserManager<ApplicationUser> userManager, EarlyWarningDbContext dbContext)
        {
            _service = service;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, PastureStatus model)
        {
            if (id != model.Id)
                return BadRequest();
            ...
            if (ModelState.IsValid)
            {
                ...
                existingReport.NumberOfAnimalsAffected = model.NumberOfAnimalsAffected;
                ...
                TempData["Success"] = "Pasture status report updated successfully.";
                return RedirectToAction(nameof(Index));
            }
        ...
        public async Task<IActionResult> Submit(Guid id)
        {
            try
            {
                ...
                report.SubmittedById = currentUser?.Id;
