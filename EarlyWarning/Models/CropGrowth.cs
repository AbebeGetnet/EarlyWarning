...
{
    public class CropGrowth : CommonAttribute
    {
        public float AtSeedStage { get; set; }
        public float AtGerminationStage { get; set; }
        public float AtGrowthStage { get; set; }
        public float AtFruitStage { get; set; }
        public float AtHarvestingStage { get; set; }
        [Required]
        [DisplayName("ወረዳ")]
