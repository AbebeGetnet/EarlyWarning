...
namespace EarlyWarning.Models.SupplyofGrain
{
    public class GrainSupply
    {
        ...
        // የእህል አቅርቦት ሁኔታ
        [Display(Name = "የእህል አቅርቦት ከባለፈው ሳምንት ጋር ሲነጻጸር")]
        [Required(ErrorMessage = "እባክዎ የእህል አቅርቦት ሁኔታ ይምረጡ")]
        ...
        public ICollection<GrainSupplyDetail>? GrainSupplyDetails { get; set; }
    }
    // የአቅርቦት ሁኔታ Enum
