...
namespace EarlyWarning.Models.PriceofGrain
{
    public class GrainPrice
    {
        ...
        // የእህል አቅርቦት ሁኔታ
        [Display(Name = "የእህል ዋጋ ከባለፈው ሳምንት ጋር ሲነጻጸር")]
        [Required(ErrorMessage = "እባክዎ የእህል ዋጋ ሁኔታ ይምረጡ")]
        ...
        public ICollection<GrainPriceDetail>? GrainPriceDetails { get; set; }
    }
    // የአቅርቦት ሁኔታ Enum
