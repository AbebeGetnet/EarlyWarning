...
namespace EarlyWarning.Migrations
{
    ...
    [Migration("20260509064211_RedignAndInitializer")]
    partial class RedignAndInitializer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EarlyWarning.Models.Locations", b =>
                {
                    ...
                    b.Property<Guid?>("RainfallReportId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("RainfallReportId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RainfallReportId");

                    b.HasIndex("RainfallReportId1");
            ...
            modelBuilder.Entity("EarlyWarning.Models.Locations", b =>
                {
                    ...
                    b.HasOne("EarlyWarning.Models.RainfallReport", null)
                        .WithMany("NoKebelesWithHighRainFall")
                        .HasForeignKey("RainfallReportId");

                    b.HasOne("EarlyWarning.Models.RainfallReport", null)
                        .WithMany("NoKebelesWithLowRainFall")
                        .HasForeignKey("RainfallReportId1");
            ...
            modelBuilder.Entity("EarlyWarning.Models.RainfallReport", b =>
                {
                    b.Navigation("NoKebelesWithHighRainFall");

                    b.Navigation("NoKebelesWithLowRainFall");
                });
